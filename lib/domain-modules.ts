export const DOMAIN_MODULES = [
  {
    ...
    files: ["lib/api/handler.ts", "lib/api/routes.ts", "lib/domain-modules.ts"],
    purpose: "Single source of truth for API route metadata and behavior module ownership.",
  },
  {
    domain: "auth",
    owner: "Authentication",
    files: ["lib/domains/auth/auth.ts", "lib/domains/auth/api-auth.ts", "lib/domains/auth/types.ts"],
  ...
  },
  {
    ...
    files: [
      "lib/domains/catalog/product-import.ts",
      "lib/domains/catalog/infer-category.ts",
  ...
  },
  {
    ...
    files: [
      ...
      "lib/domains/cash/ledger.ts",
      "lib/domains/cash/analytics.ts",
      "lib/domains/cash/types.ts",
    ],
